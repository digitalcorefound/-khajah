...
setInterval(function() {
    if (window.outerWidth - window.innerWidth > 200 || window.outerHeight - window.innerHeight > 200) {
        document.body.innerHTML = "<h1 style='text-align: center; margin-top: 20%; color: red;'>404not Found.sorry! Access to this page is not allowed. Please return to [the home page](URL of the home page) to continue browsing. </h1>";
    }
}, 1000);